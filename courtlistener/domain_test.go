...
// HTTP behaviour is covered in courtlistener_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "courtlistener://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("courtlistener", "about")
	if err != nil || got.String() != "courtlistener://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want courtlistener://page/about", got.String(), err)
	}
}
