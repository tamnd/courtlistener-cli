...
Most of these come down to network reality or how courtlistener serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

courtlistener rate-limits like any public site. courtlistener already paces
...
Where a surface is gated, courtlistener reads a cookie or token you supply
...
`courtlistener`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what courtlistener actually did
