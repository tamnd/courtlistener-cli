...
```
courtlistener <command> [arguments] [flags]
```

Run `courtlistener <command> --help` for the full flag list on any command. This
...
per operation you declare in `courtlistener/domain.go`.
